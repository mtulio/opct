...
### AI Assistant Sign-off (Required)

All AI-generated content MUST include a sign-off to maintain transparency in the AI SDLC workflow. This applies to **every** interaction with external systems:

**Git commits** — include both the footer and co-author trailer:
```
🤖 Generated with [Claude Code](https://claude.com/claude-code)
...
**GitHub PR descriptions, comments, and review thread replies** — append this signature at the end:
```
---
🤖 *Generated by [Claude Code](https://claude.com/claude-code) — AI assistant*
```

**GitHub issue comments** — same signature as above.

This sign-off is mandatory and must never be omitted. It ensures:
- Traceability of AI-generated content in the project history
- Compliance with the repository's AI SDLC standardization
- Clear distinction between human and AI contributions for reviewers
